...
def generate_launch_description():
    ...
    webots = WebotsLauncher(
        world=os.path.join(package_dir, 'worlds', 'io_wpalette.wbt'), #hall.wbt | hall_w_palette.wbt | io_wopalette.wbt | io_wpalette.wbt (io = innen und außen, w = with, wo = without)
    ...
    lidar_publisher = Node(
        ...
        output='screen',
        arguments=['1.77', '0', '0.02', '0', '0', '0', 'base_link', 'base_laser'],
    )
    lidar_publisher1 = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        output='screen',
        arguments=['1.77', '0', '0.02', '0', '0', '0', 'base_link', 'SICKS300'],
    )
    imu_publisher = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        output='screen',
        arguments=['1.45', '0', '0.095', '0', '0', '0', 'base_link', 'imu_link'],
    )
